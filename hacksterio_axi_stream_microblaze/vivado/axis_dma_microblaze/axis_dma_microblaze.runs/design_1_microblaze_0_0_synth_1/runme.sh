...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/github/CMODS7/hacksterio_axi_stream_microblaze/vivado/axis_dma_microblaze/axis_dma_microblaze.runs/design_1_microblaze_0_0_synth_1'
cd "$HD_PWD"
