...
--               /media/tcmichals/Working/xilinx/CMODS7-25/github/CMODS7/axi_dma_stream_microblaze/vivado/axis_dma/axis_dma.srcs/sources_1/bd/axis_dma_design/ip/axis_dma_design_uart_axis_0_0/axis_dma_design_uart_axis_0_0_sim_netlist.vhdl
...
entity axis_dma_design_uart_axis_0_0_sync_signal is
  port (
  ...
  attribute ORIG_REF_NAME of axis_dma_design_uart_axis_0_0_sync_signal : entity is "sync_signal";
end axis_dma_design_uart_axis_0_0_sync_signal;

architecture STRUCTURE of axis_dma_design_uart_axis_0_0_sync_signal is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axis_dma_design_uart_axis_0_0_uart_rx is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axis_dma_design_uart_axis_0_0_uart_rx : entity is "uart_rx";
end axis_dma_design_uart_axis_0_0_uart_rx;

architecture STRUCTURE of axis_dma_design_uart_axis_0_0_uart_rx is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axis_dma_design_uart_axis_0_0_uart_tx is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axis_dma_design_uart_axis_0_0_uart_tx : entity is "uart_tx";
end axis_dma_design_uart_axis_0_0_uart_tx;

architecture STRUCTURE of axis_dma_design_uart_axis_0_0_uart_tx is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axis_dma_design_uart_axis_0_0_uart_axis is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    s_axis_tready : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axis_dma_design_uart_axis_0_0_uart_axis : entity is "uart_axis";
end axis_dma_design_uart_axis_0_0_uart_axis;

architecture STRUCTURE of axis_dma_design_uart_axis_0_0_uart_axis is
  signal rx_sync : STD_LOGIC;
  signal tx_n_1 : STD_LOGIC;
begin
rx: entity work.axis_dma_design_uart_axis_0_0_uart_rx
     port map (
      SR(0) => tx_n_1,
      axis_aclk => axis_aclk,
...
sync_rx: entity work.axis_dma_design_uart_axis_0_0_sync_signal
     port map (
      axis_aclk => axis_aclk,
      rx_sync => rx_sync,
      uart_rxd => uart_rxd
    );
tx: entity work.axis_dma_design_uart_axis_0_0_uart_tx
     port map (
      SR(0) => tx_n_1,
      axis_aclk => axis_aclk,
      axis_reset => axis_reset,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axis_dma_design_uart_axis_0_0 is
  port (
    axis_aclk : in STD_LOGIC;
    axis_reset : in STD_LOGIC;
    s_axis_tdata : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of axis_dma_design_uart_axis_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axis_dma_design_uart_axis_0_0 : entity is "axis_dma_design_uart_axis_0_0,uart_axis,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axis_dma_design_uart_axis_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of axis_dma_design_uart_axis_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axis_dma_design_uart_axis_0_0 : entity is "uart_axis,Vivado 2020.1";
end axis_dma_design_uart_axis_0_0;

architecture STRUCTURE of axis_dma_design_uart_axis_0_0 is
...
begin
inst: entity work.axis_dma_design_uart_axis_0_0_uart_axis
     port map (
      axis_aclk => axis_aclk,
      axis_reset => axis_reset,
      m_axis_tdata(7 downto 0) => m_axis_tdata(7 downto 0),
