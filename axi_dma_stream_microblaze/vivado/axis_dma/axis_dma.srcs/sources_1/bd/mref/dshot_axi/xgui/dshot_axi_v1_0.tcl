...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "update_guardtime" -parent ${Page_0}
...
proc update_PARAM_VALUE.update_guardtime { PARAM_VALUE.update_guardtime } {
	# Procedure called to update update_guardtime when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.update_guardtime { PARAM_VALUE.update_guardtime } {
	# Procedure called to validate update_guardtime
	return true
}


proc update_MODELPARAM_VALUE.update_guardtime { MODELPARAM_VALUE.update_guardtime PARAM_VALUE.update_guardtime } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.update_guardtime}] ${MODELPARAM_VALUE.update_guardtime}
}
