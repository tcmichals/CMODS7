...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/github/CMODS7/axi_dma_stream_microblaze/vivado/axis_dma/axis_dma.runs/axis_dma_design_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_dma_design_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_dma_design_axis_data_fifo_0_0.tcl
