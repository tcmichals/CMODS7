...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/github/CMODS7/axi_dma_stream_microblaze/vivado/axis_dma/axis_dma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_dma_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_dma_design_wrapper.tcl
