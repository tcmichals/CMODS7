...
*/                                
localparam [15:0] GAURD_BAND_SIGNAL = 16'd5;                         
localparam [15:0] LOW_HIGH_TIME = 16'd125 - GAURD_BAND_SIGNAL;
localparam [15:0] LOW_LOW_TIME = 16'd209 + GAURD_BAND_SIGNAL;

/* For DSHOT150 clk is 50Mhz so 0-T1H is  5.00 * 50 = 250
                                0-Off is (6.67 - 5.00us) * 50 = 83.5
*/

localparam [15:0] HIGH_HIGH_TIME = 16'd250 + GAURD_BAND_SIGNAL;
localparam [15:0] HIGH_LOW_TIME = 16'd84 - GAURD_BAND_SIGNAL;


/* number of bits to shift */
localparam [4:0] NUM_BIT_TO_SHIFT = 15;
