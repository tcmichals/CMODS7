...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/axistream/vivado/axis_stream/axis_stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_dma_96mhz_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_dma_96mhz_wrapper.tcl
