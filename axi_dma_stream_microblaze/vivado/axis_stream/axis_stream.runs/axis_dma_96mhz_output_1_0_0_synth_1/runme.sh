...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/axistream/vivado/axis_stream/axis_stream.runs/axis_dma_96mhz_output_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_dma_96mhz_output_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_dma_96mhz_output_1_0_0.tcl
