...
HD_PWD='/media/tcmichals/Working/xilinx/CMODS7-25/axistream/vivado/axis_stream/axis_stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_dma_96mhz_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axis_dma_96mhz_wrapper.tcl -notrace
