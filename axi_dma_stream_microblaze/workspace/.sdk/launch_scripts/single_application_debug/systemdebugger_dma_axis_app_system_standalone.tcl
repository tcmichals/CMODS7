...
fpga -file /media/tcmichals/Working/xilinx/CMODS7-25/axistream/workspace/dma_axis_app/_ide/bitstream/axis_dma_96mhz_wrapper.bit
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow /media/tcmichals/Working/xilinx/CMODS7-25/axistream/workspace/dma_axis_app/Release/dma_axis_app.elf
bpadd -addr &main
